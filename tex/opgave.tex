...
Dette møder dog modstand - den edukative diskurs, der har som yderste nederlag, an mennesker blot er til \autocite{lieberkindEdukativeDiskurs2016}\todo{bekræft citat}, er også udbredt til de handicappede.

\section{Indeværende teksts (sociale) formål}
\todo{bedre forbindelse med overskrift - og en afslutning!}
...
citetitle{klStyringAfDet2017} falder i netop den “fælde”, som \citeauthor{scheurichPolicyArchaeologyNew1994} beskriver: man tager problemet for givet, og søger en løsning, der kan opretholde samfundets sammenhængskraft.
